            ...
            <form class="form-horizontal" method="POST" action="<?php echo site_url('C_Customer/editc')?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="namacustomer" value="<?php echo $customer->namacustomer ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea class="form-control" rows="3" id="alamat" name="alamat"><?php echo $customer->alamat ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Telepon </label>
                  <div class="col-xs-4 ">
                    <input type="text" class="form-control col-xs-4" id="tlp_Customer" name="tlp" value="<?php echo $customer->tlp ?>"  maxlength="12" minlength="8" onkeypress="return Angkasaja(event)">
                  </div>
                  <label for="inputEmail3" class="col-sm-1 control-label">Hp </label>
                  <div class="col-xs-4 ">
                    <input type="text" class="form-control col-xs-4" id="tlp_Customer" name="hp" placeholder="HP"  maxlength="12" minlength="8" value="<?php echo $customer->hp ?>" onkeypress="return Angkasaja(event)">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Limit</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="rupiah" name="limit" value=" Rp. <?php echo number_format($customer->limit,0,",","."); ?>">
