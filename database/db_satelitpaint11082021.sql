...
--
-- Table structure for table `id_dtlresep`
--

CREATE TABLE `id_dtlresep` (
  `id_dtlresep` int(11) NOT NULL,
...
(10, 10, 'administrator', '0', '0', '0', '0'),
(11, 11, 'administrator', '1', '1', '1', '1'),
(12, 12, 'administrator', '0', '0', '0', '0'),
...
CREATE TABLE `tb_barang` (
  ...
  `jensbarang` enum('baku','jual') NOT NULL,
...
--
-- Table structure for table `tb_dtlpembelian`
--

CREATE TABLE `tb_dtlpembelian` (
  `id_dtlpembelian` int(11) NOT NULL,
...
--
-- Table structure for table `tb_dtlpenjualan`
--

CREATE TABLE `tb_dtlpenjualan` (
...
CREATE TABLE `tb_kaskeluar` (
  ...
  `id_user` int(11) NOT NULL,
  `tgl_update` date NOT NULL,
  `jeniskk` enum('pembelian','komisi','dll') NOT NULL,
...
CREATE TABLE `tb_komisi` (
  ...
  `tgl_periodeawal` date NOT NULL,
  `tgl_periodeakhir` date NOT NULL,
  `tgl_update` date NOT NULL,
  `id_user` int(11) NOT NULL,
...
CREATE TABLE `tb_menu` (
  ...
  `kat` enum('data master','setting','transaksi','produksi','stok','accounting','laporan') NOT NULL,
  `icon` varchar(25) NOT NULL,
  `linkmenu` varchar(20) NOT NULL,
...
INSERT INTO `tb_menu` (`id_menu`, `menu`, `kat`, `icon`, `linkmenu`, `statusmenu`) VALUES
(1, 'Data User', 'data master', 'fa fa-user-secret', 'user', 'aktif'),
(2, 'Data Sales', 'data master', 'fa fa-user', 'sales', 'aktif'),
(3, 'Data Customer', 'data master', 'fa fa-users', 'customer', 'aktif'),
(4, 'Data Suplier', 'data master', 'fa fa-users', 'suplier', 'aktif'),
(5, 'Data Satuan', 'data master', 'fa fa-balance-scale', 'customer', 'aktif'),
(6, 'Data Barang', 'data master', 'fa fa-bars', 'barang', 'aktif'),
...
(16, 'Hutang', 'accounting', 'fa fa-exclamation', 'hutang', 'aktif'),
(17, 'Piutang', 'accounting', 'fa fa-exclamation', 'piutang', 'aktif'),
(18, 'Komisi', 'accounting', 'fa fa-money', 'komisi', 'aktif'),
(19, 'Kas Keluar', 'accounting', 'fa fa-pencil-square-o', 'kaskeluar', 'aktif'),
(20, 'Laporan Penjualan', 'laporan', 'fa fa-file-text-o', 'lappenjualan', 'aktif'),
(21, 'Laporan Pembelian', 'laporan', 'fa fa-file-text-o', 'lappembelian', 'aktif'),
(22, 'Laporan Komisi', 'laporan', 'fa fa-file-text-o', 'lapkomisi', 'aktif');
...
CREATE TABLE `tb_mutasi` (
  ...
  `id_barang` int(11) NOT NULL,
  `qtt` int(11) NOT NULL,
  `jenismutasi` enum('jual','beli','produksi','retur') NOT NULL,
  `ket` varchar(100) NOT NULL,
  `id_user` int(11) NOT NULL,
  `tgl_update` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tb_pembelian` (
  ...
  `totalnota` int(11) NOT NULL,
  `diskonnota` int(11) NOT NULL,
  `subtotalnota` int(11) NOT NULL,
...
(1, 'Administrator', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'administrator', 1, '2021-08-11'),
(2, 'alief', 'kasirali', '4c156d3813d1ccd36112b02ef3f32026', 'kasir', 1, '2021-08-11'),
(3, 'RIZKY FEBRIANTO', '12345678', '25d55ad283aa400af464c76d713c07ad', 'administrator', 2, '2021-08-11');
...
--
-- Indexes for table `id_dtlresep`
--
ALTER TABLE `id_dtlresep`
  ADD PRIMARY KEY (`id_dtlresep`);
...
--
-- Indexes for table `tb_dtlpembelian`
--
ALTER TABLE `tb_dtlpembelian`
  ADD PRIMARY KEY (`id_dtlpembelian`);

--
-- Indexes for table `tb_dtlpenjualan`
--
ALTER TABLE `tb_dtlpenjualan`
...
--
-- AUTO_INCREMENT for table `id_dtlresep`
--
ALTER TABLE `id_dtlresep`
  MODIFY `id_dtlresep` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_akses`
--
ALTER TABLE `tb_akses`
  MODIFY `id_akses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1753;
...
--
-- AUTO_INCREMENT for table `tb_dtlpembelian`
--
ALTER TABLE `tb_dtlpembelian`
  MODIFY `id_dtlpembelian` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_dtlpenjualan`
--
ALTER TABLE `tb_dtlpenjualan`
  MODIFY `id_dtlpenjualan` int(11) NOT NULL AUTO_INCREMENT;
